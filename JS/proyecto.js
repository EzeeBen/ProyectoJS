...
let sumNot = 0;
let sumEda = 0;
const alumnado = [{nombre, edad, altura, nota}];

alert("Ingresar los datos de 4 alumnos");

for (let i = 0; i = 3; i++) {
  let nombre = prompt("Nombre del alumno");
  let edad = parseInt(prompt("Edad del alumno"));
  let altura = parseInt(prompt("Altura del alumno"));
  let nota = parseInt(prompt("Nota del alumno"));

  let alumno = { nombre, edad, altura, nota };
  alumnado.push(alumno);
}
function promedioA() {
  sumAlt = sumAlt + alumnos.altura;
  let promAlt = sumAlt / cantAlum;
  return promAlt;
}

function promedioN() {
  sumNot = sumNot + alumnos.nota;
  let promNot = sumAlt / cantAlum;
  return promNot;
}

function promedioE() {
  sumEda = sumEda + alumnos.edad;
  let promEda = sumAlt / cantAlum;
  return promEda;
}
let cantAlum = parseInt(prompt("Cantidad de alumnos a ingresar: "));
...
let seleccion = prompt(
  "Elija que quiere saber: \n1- Promedio de alturas \n2- Promedio de notas \n3- Promedio de edades \n4- Que alumnos aprobaron la materia"
);
switch (seleccion) {
  case "1":
    alert("El promedio de alturas es: " + promAlt);
    break;

  case "2":
    alert("El promedio de notas es: " + promNot);
    break;

  case "3":
    alert("El promedio de edades es: " + promEda);
    break;

  case "4":
    for (const alumno of alumnado) {
      if (alumno.nota >= 7) {
        alert(alumno.nombre + " aprobo la materia! :D");
      } else {
        alert(alumno.nombre + " NO aprobo la materia! :(");
      }
    }
    break;
}
